...
<div class="container">
    <div class="header">
        ...
        <p>支持爱奇艺、腾讯视频、优酷、芒果TV、哔哩哔哩等主流平台 · 框架版本 v<?php echo \Core\App::VERSION; ?></p>
    </div>
    ...
    <div class="footer">
        接口文档见 <a href="api.php?url=https://www.iqiyi.com/v_1re8v439zmw.html" target="_blank">/api.php</a> ·
        本工具仅供学习交流使用
    </div>
</div>
